...
void ValueCurentFrec(float value,float frec)
  {
      value=valuefrec(frec,value,2);
  }
void ValueVoltageFrec(float value,float frec)
  {
      value=valuefrec(frec,value,1);
  }
...
//        break;
    ...
    channel_input(fd,1,HarmonicVoltage,HarmonicVoltagePhase,HarmonicVoltageFreq,BaseVoltage,BaseVoltagePhase,Ferequencer,V1DC,1,0,0,0);
    ...
    {
    case 1:
     channel_input(fd,0,HarmonicCurrent,HarmonicCurrentPhase,HarmonicCurrentFreq,BaseCurrent,BaseCurrentPhase,Ferequencer,I1DC,1,0,0,0);
     artExec(fd,"others:steptime(1)",result,0);
     artExec(fd,"out:ana:i(1:1):on",result,0);
     break;
    case 2:
     channel_input(fd,0,HarmonicCurrent,BaseCurrentPhase,HarmonicCurrentFreq,BaseCurrent,BaseCurrentPhase,Ferequencer,I2DC,2,0,0,0);
     artExec(fd,"others:steptime(1)",result,0);
     artExec(fd,"out:ana:i(1:2):on",result,0);
     break;
    case 3:
     channel_input(fd,0,HarmonicCurrent,BaseCurrentPhase,HarmonicCurrentFreq,BaseCurrent,BaseCurrentPhase,Ferequencer,I3DC,3,0,0,0);
     artExec(fd,"others:steptime(1)",result,0);
