...
void ValueFrec()
  {
      HarmonicCurrentStart=valuefrec(H_Ferequencer1,HarmonicCurrentStart,2);
  }
...
void OutputSequencer(int fd)
  {
   ...
   //  artExec(fd,"inp:dig(1):thres(1)",result,0);//打开放大器
    ...
    channel_input1(fd,1,0,0,0,m_Ch[3].DC,4,0,0,0);
    ...
    channel_input1(fd,1,m_Ch[0].Amp,m_Ch[0].H_Phase,H_Ferequencer,m_Ch[0].DC,1,0,0,0);
    artExec(fd,"out:ana:v(1:1):on",result,0);
    channel_input1(fd,1,m_Ch[1].Amp,m_Ch[1].H_Phase,H_Ferequencer,m_Ch[1].DC,2,0,0,0);
    artExec(fd,"out:ana:v(1:2):on",result,0);
    channel_input1(fd,1,m_Ch[2].Amp,m_Ch[2].H_Phase,H_Ferequencer,m_Ch[2].DC,3,0,0,0);
    ...
    {
    case 1:
     channel_input(fd,0,HarmonicCurrentStart,H_Phase,H_Ferequencer1,H_Current,H_Phase,H_Ferequencer,m_Ch[4].DC,1,0-HarmonicStepValue,0,0);
     artExec(fd,"others:steptime(1)",result,0);
     artExec(fd,"out:ana:i(1:1):on",result,0);
     break;
    case 2:
     channel_input(fd,0,HarmonicCurrentStart,H_Phase,H_Ferequencer1,H_Current,H_Phase,H_Ferequencer,m_Ch[5].DC,2,0-HarmonicStepValue,0,0);
     artExec(fd,"others:steptime(1)",result,0);
     artExec(fd,"out:ana:i(1:2):on",result,0);
     break;
    case 3:
     channel_input(fd,0,HarmonicCurrentStart,H_Phase,H_Ferequencer1,H_Current,H_Phase,H_Ferequencer,m_Ch[6].DC,3,0-HarmonicStepValue,0,0);
     artExec(fd,"others:steptime(1)",result,0);
    ...
    sumstep=floor(fabs((HarmonicStart-HarmonicEnd)/(HarmonicStep/*-HarmonicStepError*/)))+1;//2016-5-11谐波changvalue变化范围修改
    out_time=sumstep*A_StepTime;
