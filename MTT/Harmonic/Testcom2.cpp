...
void artExec(int fd, char *command_str,unsigned char *result1,int max_result_length)
{
      ...
      unsigned char sys_data[100],inp_data[100],seq_data[100],amp_data[100],out_data2[100];
                          ...
                          if(memcmp(p1,"a(",2)==0)
                            ...
                            {//此解释为谐波中的sig2的幅值
                              ...
                              if(memcmp(p1,"step",4)==0)
                                ...
                                {y=chang_amp(x,&max_output);
                                  out_data[24]=(unsigned char)y;//2017-7-25差异备注
                        ...
                        if(memcmp(p1,"v(",2)==0)
                               {
                                ...
                                if(memcmp(p1,"sig1",4)==0)
                                 out_data[9]=0x00;//2017-7-25 差异备注
                                else if(memcmp(p1,"sum",3)==0)
                                 out_data[9]=0x01;
                         ...
                         else if(memcmp(p1,"i(",2)==0)
                               {
                                ...
                                p1=p1+2;
                                if(memcmp(p1,"sig1",4)==0)
                                 out_data[9]=0x04;//2017-7-25 差异备注
                                else if(memcmp(p1,"sum",3)==0)
                                 out_data[9]=0x05;
                                else if(memcmp(p1,"add",3)==0)
                                 out_data[9]=0x06;
...
// amplifier parmeter change
void channel_input(int fd,int type,double value, double phan,double frec,double value1, double phan1,double frec1,int sin_dc_status1,int channel_status,double value_step,double phase_step,double frec_step)
   {
        //type=1 -->voltage
        // type=0 -->current
         //sin_dc_status1=0 -->sin
