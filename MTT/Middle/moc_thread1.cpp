...
static const char qt_meta_stringdata_thread1[] = {
    ...
    "SIG_binarystate(int)\0num\0SIG_testresult(int)\0"
    "flag1,value1,flag2,value2\0"
    "SIG_DisplayChangeValue(int,QString,int,QString)\0"
...
void thread1::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->SIG_testresult((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->SIG_DisplayChangeValue((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3])),(*reinterpret_cast< QString(*)>(_a[4]))); break;
...
// SIGNAL 3
void thread1::SIG_DisplayChangeValue(int _t1, QString _t2, int _t3, QString _t4)
{
