...
static const char qt_meta_stringdata_thread1[] = {
    "thread1\0\0state\0SIG_binarystate(int)\0"
    "SIG_dspstate(int)\0num\0SIG_testresult(float)\0"
    ",\0SIG_DisplayChangeValue(int,float)\0"
...
void thread1::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->SIG_binarystate((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->SIG_dspstate((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->SIG_testresult((*reinterpret_cast< float(*)>(_a[1]))); break;
        case 3: _t->SIG_DisplayChangeValue((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< float(*)>(_a[2]))); break;
...
// SIGNAL 2
void thread1::SIG_testresult(float _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 3
void thread1::SIG_DisplayChangeValue(int _t1, float _t2)
{
