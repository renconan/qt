...
double max_output_i_c=42.42;//,max_f_i_c=50,min_f_i_c=0.5,output_offset_i_c=0,amp_i_c=315;

unsigned char data_i_a[70],data_i_b[70],data_v_b[70],data_v_a[70],data_v_c[70];
...
void artExec(int fd,  char *command_str,unsigned char *result1,int max_result_length)
    {
      ...
      unsigned char sys_data[40],inp_data[40],seq_data[40],amp_data[40],out_data2[70],wavetable[200];
