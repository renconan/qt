...
static const char qt_meta_stringdata_Import[] = {
    "Import\0\0item\0"
    "on_listWidget_itemDoubleClicked(QListWidgetItem*)\0"
    "event\0moveEvent(QMoveEvent*)\0"
};
...
const QMetaObjectExtraData Import::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Import::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Import,
      qt_meta_data_Import, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Import::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Import))
